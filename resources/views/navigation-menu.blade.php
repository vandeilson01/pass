            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <ul class="flex flex-wrap items-center justify-center text-gray-900 dark:text-white">
                        <li class="border p-1">
                            <a href="#" class="text-xs me-4 hover:underline m-1 md:me-4 ">Bonus<br/><?php 
                ...
                ?></a>
                        ...
                        <li class="border p-1">
                            <a href="#" class="text-xs me-4 hover:underline m-1 md:me-4">Balance<br/><?php 
                    $user = auth()->user()->load('bonus');
                ...
                ?></a>
                        ...
                        <li class="border p-1">
                            <a href="#" class="text-xs me-4 hover:underline m-1 md:me-4 ">Currency<br/><?php 
                ...
                ?></a>
                        ...
                        <li class="border p-1">
                            <a href="#" class="text-xs me-4 hover:underline m-1 md:me-4">Agent Type<br/><?php 
                ...
                ?></a>
                        ...
                        <li class="border p-1">
                            <a href="#" class="text-xs me-4 hover:underline m-1 md:me-4">API Type<br/><?php 
                ...
                ?></a>
                        ...
                        <li class="border p-1">
                            <a href="#" class="text-xs me-4 hover:underline m-1 md:me-4">Agent Rtp<br/><?php 
                        ...
                        <li class="border p-1">
                            <a href="#" class="text-xs me-4 hover:underline m-1 md:me-4">Agent GGR<br/>
                            <?php 
                ...
                ?></a>
                        ...
                        <li class="border p-1">
                            <a href="#" class="text-xs me-4 hover:underline m-1 md:me-4">Agent Rtp<br/><?php 
                                ...
                                $r = DoubleBet::where('user_id', auth()->user()->id)->sum('bet') ?? 1;
                                $p = CrashBet::where('user_id', auth()->user()->id)->sum('bet') ?? 1;
                                $t = Mines::where('user_id', auth()->user()->id)->sum('bet') ?? 1;
